...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#viewDataYourCreated').DataTable({
                ...
                ajax: function(data, callback, settings) {
                    var date = $('#date').val();
                    var urlx = "{{ route('admin.transaction.get', ['date' => '__NUMBER__']) }}"
        ...
        function showVisit(insi) {

            var urlx = "{{ route('admin.transaction.show', ['id' => '__NUMBER__']) }}".replace('__NUMBER__', insi);
            $.ajax({
                url: urlx ,
                method: "GET",
